...
tehpodderjka.add(InlineKeyboardButton('Тех. поддержка', url='https://t.me/GoldBloger'))
tehpodderjka.add(InlineKeyboardButton(text="Пополнить баланс",callback_data="pay"))

partnerss = InlineKeyboardMarkup()
partnerss.add(InlineKeyboardButton('Заказать рекламу', url='https://t.me/GoldBloger'))
partnerss.add(InlineKeyboardButton('Канал', url='https://t.me/zombiepiar'))

chatik = InlineKeyboardMarkup()
chatik.add(InlineKeyboardButton('Наш чат', url='https://t.me/tgzombiepiar'))
# Подписка на канал
